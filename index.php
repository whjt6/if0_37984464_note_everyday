    ...
    <table>
        ...
        if ($result) {
            ...
            <tr>
                ...
                <td>
                    <?php
                    $created_at = new DateTime($row['created_at'], new DateTimeZone('UTC')); // Ambil waktu dari database
                    $created_at->setTimezone(new DateTimeZone('Asia/Jakarta')); // Ubah ke zona waktu lokal
